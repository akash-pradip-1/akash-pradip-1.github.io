...
var iframe = $("#google_map");
iframe.attr("src", iframe.data("src"));
$('img[data-src]').each(function() {
        $(this).attr('src', $(this).attr('data-src')).removeAttr('data-src');
    });

$().toastmessage('showToast',{text:'DarkDeveloper Welcomes You !',sticky:false,position:'bottom-right',type:'notice',inEffectDuration:1000,stayTime:7000,});function toast(type,message){$().toastmessage('showToast',{text:message,sticky:false,position:'bottom-right',type:this.type,inEffectDuration:1000,stayTime:7000,});}
var x=0;var msg='';var ip;$.get('https://ipinfo.io',function(response){ip=(response.ip);var city=(response.city);var region=(response.region);var country=(response.country);var loc=(response.loc);var org=(response.org);},'jsonp');function counter(){x++;switch(x)
{case 1:msg="Hello "+ip;break;case 2:msg='Akash this side.';break;case 3:msg='Thank you for visiting my website :)';break;case 4:msg='Be somebody nobody thought you could be.';break;case 5:msg='In the middle of every difficulty lies opportunity.';break;case 6:msg='It is not the mountain we conquer but ourselves.';break;case 7:msg='He who has a why to live can bear almost any how.';break;case 8:msg='Begin anywhere.';break;case 9:msg='Everything you can imagine is real.';break;case 10:msg='You are never too old to set another goal or to dream a new dream.';break;case 11:msg='The really great man is the man who makes every man feel great.';break;case 12:msg='Compassion is language the deaf can hear and the blind can see.';break;case 13:msg='Hope you like my page.';break;case 14:msg="I'd appreciate your feedback";break;case 15:msg='Your feedback is important for my improvement.';break;case 16:msg='Suggest me some new ideas.';break;case 17:msg='Hire me !!';break;case 18:msg='Want a stunning website like this? Contact Me.';break;default:x=1,msg="Hello "+ip;}
toast('showNoticeToast',msg);}
var myVar=setInterval(counter,15000);
...
});$(document).ready(function(){});document.addEventListener('contextmenu',event=>event.preventDefault());$(function(){$('[data-toggle="tooltip"]').tooltip()})
function toggle_div_fun(id){var divelement=document.getElementById(id);if(divelement.style.display=='block')
{$("#sectiontohide").hide("slow");}
else
{$("#sectiontohide").show("slow",function(){$("#sectiontohide").delay(10000).hide("slow");});}}
(function()
{var speed=1000;var moving_frequency=1;var links=document.getElementsByClassName('nav-el');var href;for(var i=0;i<links.length;i++)
{href=(links[i].attributes.href===undefined)?null:links[i].attributes.href.nodeValue.toString();if(href!==null&&href.length>1&&href.substr(0,1)=='#')
{links[i].onclick=function()
{var element;var href=this.attributes.href.nodeValue.toString();if(element=document.getElementById(href.substr(1)))
{var hop_count=speed/moving_frequency;var getScrollTopDocumentAtBegin=getScrollTopDocument();var gap=(getScrollTopElement(element)-getScrollTopDocumentAtBegin)/hop_count;for(var i=1;i<=hop_count;i++)
{(function()
...
{var top=0;while(e.offsetParent!=undefined&&e.offsetParent!=null)
{top+=e.offsetTop+(e.clientTop!=null?e.clientTop:0);e=e.offsetParent;}
return top;};var getScrollTopDocument=function()
{return document.documentElement.scrollTop+document.body.scrollTop;};})();$(function(){var selectedClass="";$(".filter").click(function(){selectedClass=$(this).attr("data-rel");$("#gallery").fadeTo(100,0.1);$("#gallery div").not("."+selectedClass).fadeOut().removeClass('animation');setTimeout(function(){$("."+selectedClass).fadeIn().addClass('animation');$("#gallery").fadeTo(300,1);},300);});});function check(){if(document.getElementById("checkbox7").checked==true)
{document.getElementById("message").value+=" (Hire Checked)";}
else{var word=" (Hire Checked)";var textValue=document.getElementById('message').value;if(textValue.indexOf(word)!=-1)
{var res=document.getElementById("message").value.replace(word,"");document.getElementById("message").value=res;}}}
$(document).ready(function(){$('#carousel-example-1').hammer().on('swipeleft',function(){$(this).carousel('next');})
$('#carousel-example-1').hammer().on('swiperight',function(){$(this).carousel('prev');})});
